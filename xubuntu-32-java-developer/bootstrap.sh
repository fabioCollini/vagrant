...
xfce4-whiskermenu-plugin xarchiver filezilla
...
echo "------------------------"
wget http://eclipse.mirror.garr.it/mirrors/eclipse/technology/epp/downloads/release/kepler/SR2/eclipse-jee-kepler-SR2-linux-gtk.tar.gz -P /tmp
